...
Now, we will save our regression result is a HTML table so that we can use to present it in our manuscript or our supplementary material.

```{r}
# Save the table as a HTML file
html_file <- here("results", "supplementary-tables", "regression_results.html")
...
dw_results <- data.frame(
  ...
  `p-value` = dw_p_value,  
  check.names = FALSE      # Preserve the column name formatting
)
