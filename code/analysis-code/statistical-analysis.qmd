...
# Save the regression results to an HTML file
modelsummary(
  model,
  output = here("results", "tables", "preliminary_regression_results.html"),
  title = "First Attempt at Regression Model",
...
dw_test_lagged <- dwtest(fixed_model_lm)
print(dw_test_lagged)
```
