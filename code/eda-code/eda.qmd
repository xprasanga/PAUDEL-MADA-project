...
# Save the table object as an RDS file
...
# Creating the line plot
ggplot(data_filtered, aes(x = Year, y = Current_health_expenditure_per_capita_current_US, color = CountryName, group = CountryName)) +
  geom_line(size = 1) +
  geom_point(size = 2) +  
  labs(
