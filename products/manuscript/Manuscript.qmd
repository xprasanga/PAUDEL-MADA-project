...
_Understanding the determinants of health expenditures is a critical job in order to optimize the healthcare systems and policymaking. This study utilizes the Ordinary Least Squares method to analyze the factors affecting per capita health expenditure of a country among the OECD nations during 2010 to 2020. Our study identifies that GDP growth, control of corruption, and  unemployment rate among the youth in the labor force have a significant and an important role in determining the amount of money spent on health sector by the country, while Foreign Direct Investment exhibits a significant but low magnitude impact. Factors such as income share held by the lowest 20-percent population, trade as a percentage of GDP, access to electricity among rural popuation, and age dependency ration showed no statistical significant impact on the health expenditure. We also applied Random Forest model to explain the factors affecting per capita health expenditure of a country. The results of both the OLS model and Random forest was tested using cross-validation and train/test technique, and we found that our OLS model shows a consistent result across all tests. Although Random Model was found to have a better explanation capability, the inconsistensies raised a question on it's validity. Our findings highlight the importance of economic and institutional factors in shaping the health expenditure and offer insights for policimakers aiming to enhance healthcare accessibility and efficiency. _

{{< pagebreak >}}

# Introduction

## Health expenditure as an indicator

Health expenditure is an important indicator of a country's committment to citizen's well-being and efficiency of it's healthcare systems. Among the OECD (Organisation for Economic Co-operation and Development) countries, the per capita health expenditure vary significantly ranging from 1,000 USD to over 10,000 USD [@2021].
Understanding the factors that drive these differences is important for policymakers to optimize healthcare delivery and improving healthcare access. While GDP had been one of the primary determinant of health expending [@Newhouse1977], recent studies suggest that institutional, demographic, and socio-economic factors may also play a crucial role in determination of health expenditure among different countries [@Ziegler2017]. The relationship between health expenditure and their determinants because particularly relevant in the context of recent global challenges. The recent COVID-19 pandemic also exposed the vulnerabilities in global healthcare systems with countries showing high pre-pandemic health expenditure generally demonstrating greater resilience [@WHO2022]
...
#| fig-cap: "Additional correlation based on 2010 data"
#| echo: FALSE
#| out.width: "100%"
...
#| tbl-cap: "Random Forest importance plot"
#| echo: FALSE
#| out.width: "100%"
