...
We ran the regression based on our primary model described in the [proposed model for the research](#model) section of this article. The results obtained from the regression analysis are presented by @tbl-preliminary-regression-results.


```{r}
#| label: tbl-preliminary-regression-results
#| tbl-cap: "Preliminary Regression Results"
#| echo: FALSE
#| out.width: "70%"
